...
/* SYMBOL
 * .--------------------------------------------------------------------------------------------------------------------------------------.
 * |        | F1     | F2     | F3     | F4     | F5     | F11    | F12    |        | F6     | F7     | F8     | F9     | F10    | A_BSPC |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * |TG(_Q)  |        |        |        |        |        |        | WAKE   |        |        |        |        |        |        | A_DEL  |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * |        |        |        |        |        |        |        | RESET  |        |        |        |        |        |        |        |
 ...
 */
 [SMB] = LAYOUT_ortho_5x15(
   ...
   TG(_Q) , CL_L   , CL_O   , CL_R   , _______, _______, _______, KC_WAKE, _______, _______, _______, _______, _______, _______, A_DEL  ,
